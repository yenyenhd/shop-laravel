    ...
    <div class="col-md-9">
        <div class="col-md-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control @error('guard_name') is-invalid @enderror" name="guard_name" value="{{ $role->guard_name }}">
                    ...
                    <div class="row">
                        @foreach($parentItem->permissionChildren as $childItem)
                            <div class="card-body text-primary col-md-3">
                                <h5 class="card-title"><label><input type="checkbox" 
                                    class="checkbox_children" {{ $permissionChecked->contains('id', $childItem->id) ? "checked" : '' }} 
                                        name="permission_id[]" value="{{ $childItem->id }}">
                                    </label>
                                        {{ $childItem->name }}
                                </h5>
                            </div>
